				...
				<div class="p-8">
					<div class="flex flex-col sm:flex-row items-center">
						...
						<div class="text-center sm:text-left">
							<h1 class="text-3xl font-bold text-base-content" in:fly={{ y: 20, duration: 300 }}>
								{$user.username}
							</h1>
							<p class="text-sm text-base-content/70 mt-1" in:fly={{ y: 20, duration: 300, delay: 100 }}>
					...
					<div class="mt-8 border-t border-base-300 pt-8">
						...
						<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
							...
							<div>
								...
								{:else}
									<button class="btn btn-sm btn-primary mt-1" onclick="my_modal_2.showModal()">
										Connect Telegram
									</button>
								{/if}
							</div>
...
<dialog id="my_modal_2" class="modal">
	<div class="modal-box">
		...
		<p class="py-4">
			Link your profile to our Telegram bot for instant updates and personalized content. Stay connected on-the-go!
		</p>
		<div class="flex flex-col items-center space-y-4">
			<a href="https://t.me/redrubyone_bot" target="_blank" rel="noopener noreferrer" class="btn btn-primary w-full">
				Open Telegram Bot
			</a>
